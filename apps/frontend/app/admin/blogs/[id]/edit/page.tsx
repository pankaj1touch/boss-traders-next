...
import { useAdminGetBlogByIdQuery, useUpdateBlogMutation } from '@/store/api/blogApi';
...
export default function EditBlogPage() {
  ...
  const { data: blogData, isLoading: isLoadingBlog } = useAdminGetBlogByIdQuery(blogId);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      dispatch(addToast({ type: 'success', message: result.message || 'Blog updated successfully!' }));
      ...
      <div className="min-h-screen bg-background">
        <div className="container-custom py-20">
          <div className="animate-pulse">
            <div className="mb-8 h-8 w-1/3 rounded bg-gray-200 dark:bg-gray-800" />
    ...
    <div className="min-h-screen bg-background">
      ...
      {showPreview && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
          <div className="max-h-[90vh] w-full max-w-4xl overflow-auto rounded-xl bg-white p-6 dark:bg-gray-800">
            ...
            <div className="prose prose-lg max-w-none dark:prose-invert">
              ...
              <p className="text-xl text-gray-600 dark:text-gray-400">{formData.excerpt}</p>
