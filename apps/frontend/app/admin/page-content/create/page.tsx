...
import { useCreatePageContentMutation } from '@/store/api/pageContentApi';
...
export default function CreatePageContentPage() {
  ...
  const [createPageContent, { isLoading }] = useCreatePageContentMutation();
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await createPageContent(formData as any).unwrap();
      dispatch(addToast({ type: 'success', message: 'Page content created successfully!' }));
      router.push('/admin/page-content');
    } catch (error: any) {
      const errorMessage = error?.data?.message || error?.message || 'Failed to create page content';
      ...
      <div className="border-b bg-white py-6 dark:bg-gray-900">
        <div className="container-custom">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-3xl font-bold">Create Page Content</h1>
              <p className="text-gray-600 dark:text-gray-400">
                Add content for About Us, Contact, or Careers page
              </p>
            </div>
          </div>
        </div>
            ...
            <div className="lg:col-span-2">
              <Card>
                ...
                <CardContent className="space-y-6">
                  {/* Page Type */}
                  <div>
                    <label htmlFor="pageType" className="mb-2 block font-medium">
                      Page Type *
                    </label>
                    <select
                      id="pageType"
