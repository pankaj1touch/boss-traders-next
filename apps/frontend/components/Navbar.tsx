        ...
        <div className="flex h-16 items-center justify-between gap-4">
          ...
          <Link href="/" className="flex shrink-0 items-center gap-2 md:gap-3">
            ...
            <span className="hidden text-sm font-bold text-gray-900 dark:text-white sm:block md:text-base lg:text-xl">
              <span className="block leading-tight tracking-tight">BOSS <span className="text-brand-gold">TRADERS</span></span>
              <span className="text-xs font-medium text-brand-blue/80 md:text-sm tracking-widest">INVESTOR CLASS</span>
            </span>
          </Link>
